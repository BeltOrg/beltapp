...
require_env AUTH_JWT_ACCESS_SECRET
require_env AUTH_REFRESH_TOKEN_PEPPER
...
upsert_secret "AUTH_JWT_ACCESS_SECRET" "${AUTH_JWT_ACCESS_SECRET}"
upsert_secret "AUTH_REFRESH_TOKEN_PEPPER" "${AUTH_REFRESH_TOKEN_PEPPER}"

for secret_name in DATABASE_URL DATABASE_URL_DIRECT REDIS_URL AUTH_JWT_ACCESS_SECRET AUTH_REFRESH_TOKEN_PEPPER; do
  grant_secret_accessor "${secret_name}" "serviceAccount:${DEPLOYER_SERVICE_ACCOUNT_EMAIL}"
done

for secret_name in DATABASE_URL REDIS_URL AUTH_JWT_ACCESS_SECRET AUTH_REFRESH_TOKEN_PEPPER; do
